# 📝 Scenario 04: RAG Poisoning Attack
...
## 🎯 Objective
Inject malicious data into the RAG knowledge base (file-based `knowledge_base/` directory) to corrupt the Retrieval-Augmented Generation system's output.
