# 📝 Scenario 10: AI SOC Analyst (Alert Triage)
...
## 🎯 Objective
Build a Defensive AI pipeline that automatically triages Wazuh alerts, filters false positives, and maps threats to MITRE ATT&CK.
