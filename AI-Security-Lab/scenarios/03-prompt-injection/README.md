# 📝 Scenario 03: LLM Prompt Injection & Jailbreak
...
## 🎯 Objective
Exploit an LLM application by overriding its system prompt to leak secret keys, and implement input validation and Splunk detection to catch injection attempts.
