# 📝 Scenario 17: Purple Team AD Attack + AI Detection
...
## 🎯 Objective
Execute advanced Active Directory lateral movement on the GCP Windows VMs and use local AI scripts to correlate the distributed WinEventLogs.
