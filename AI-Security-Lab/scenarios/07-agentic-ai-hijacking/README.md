# 📝 Scenario 07: Agentic AI Hijacking (Excessive Agency)
...
## 🎯 Objective
Exploit an AI Agent that has been granted excessive privileges (System Shell access) to execute unauthorized system commands.
