# 📝 Scenario 11: AI Anomaly Detection (Isolation Forest)
...
## 🎯 Objective
Train an unsupervised machine learning model to establish a network baseline and detect slow, stealthy C2 beaconing.
