# 📝 Scenario 15: DNS Tunneling + AI Detection
...
## 🎯 Objective
Simulate data exfiltration over DNS and build an ML classifier using Random Forest to detect the high-entropy query patterns.
